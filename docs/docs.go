...
const docTemplate = `{
        ...
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Начало временного промежутка, формат YYYY-MM-DD",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Конец временного промежутка, формат YYYY-MM-DD",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_IvanJSBog_goland-todo-app_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_IvanJSBog_goland-todo-app_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
